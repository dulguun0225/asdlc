...
- **Status:** superseded by [ADR-0031](0031-heterogeneous-runners.md), 2026-08-05 — the owner made
  ...
  survives as a clause of ADR-0031's admission contract; the replacement mechanism was decided
  the same day — [ADR-0032](0032-stage-delivery-via-skills-cli.md), Agent Skills via the
  `skills` CLI: canonical source, committed copies never hand-maintained, verified
