...
| [0029](0029-bundle-holds-only-installable-components.md) | `tools/spec-kit-bundle/` holds only what `specify` can install; the merge gate moves to `tools/spec-kit-checker/` | accepted; narrows the directory 0025 created, since deleted (0035) — the residual rule survives; the checker was harvested into `tools/feature-artifact-checker/` (0036) | 2026-08-05 |
...
| [0035](0035-bundle-retired-and-deleted.md) | The bundle is retired and deleted | accepted; supersedes 0026, moots 0030 part 3's worked example — the checker stays; part 2 amended by 0036, which harvested it | 2026-08-05 |
| [0036](0036-checker-harvested-fork-seed.md) | The checker is harvested: fork now, `spec-kit-checker` deleted | accepted; amends 0035 part 2, closes the fork-vs-extend open parameter, consumes 0029's second reversal condition | 2026-08-05 |
