...
| **Observability backend** — collector, metrics, trace store, gate-record store, dashboards | research ([OQ-14](../reference/open-questions.md)) | **yes — phase-0 prerequisite 6, both variants** |
