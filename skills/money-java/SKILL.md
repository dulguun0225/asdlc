...
- **Refuted reason — do not reintroduce.** "Libraries ship no monetary algorithms, so allocation and rounding stay hand-written either way" true but mis-framed: treat missing *algorithm* as missing *value type*.
