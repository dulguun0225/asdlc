...
| *(stage-procedure renderer)* | Renders the four stage procedures from [asdlc/skills/](../asdlc/skills/README.md) per runner | **Not built, mechanism undecided** — [OQ-19](../reference/open-questions.md#oq-19--runner-neutral-stage-procedure-delivery). Replaces the `asdlc-plugin/` plan of [ADR-0024](../reference/decisions/0024-stage-skill-distribution.md), superseded by [ADR-0031](../reference/decisions/0031-heterogeneous-runners.md); the leading candidate renderer is `spec-kit-bundle/`'s integration layer |
