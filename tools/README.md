...
| [stacks/self-hosted-integrated/](stacks/self-hosted-integrated/README.md) | The [integrated variant](../variants/self-hosted-integrated.md)'s code-host layer as code: Forgejo compose file plus scripts applying the sheet's §4 host configuration (accounts, branch protection). One directory per variant sheet under `stacks/`, named as the sheet is. Demonstrates the *fallback* shape ([ADR-0043](../reference/decisions/0043-primary-variant-self-hosted-assembled.md)); not production | **Built**; both scripts verified against a live Forgejo 16.0.2, 2026-08-10. No CI — it needs a Docker daemon |
